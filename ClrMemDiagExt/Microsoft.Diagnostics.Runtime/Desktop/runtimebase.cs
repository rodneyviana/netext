...
namespace Microsoft.Diagnostics.Runtime.Desktop
{
    ...
    abstract internal class DesktopRuntimeBase : RuntimeBase
    {
        ...
        {
            uint size;
            _moduleSizes.Value.TryGetValue(address, out size);
            return size;
        }
        ...
        public override IList<ClrAppDomain> AppDomains { get { return _appDomains.Value.Domains; } }
        public override IList<ClrThread> Threads { get { return _threads.Value; } }
        ...
        public override ClrHeap Heap { get { return _heap.Value; } }

        [Obsolete]
        public override ClrHeap GetHeap() { return _heap.Value; }
        ...
        public override ClrThreadPool ThreadPool { get { return _threadpool.Value; } }

        [Obsolete]
        public override ClrThreadPool GetThreadPool() { return _threadpool.Value; }
        
        public ulong SystemDomainAddress { get { return _appDomains.Value.System.Address; } }
        public ulong SharedDomainAddress { get { return _appDomains.Value.Shared.Address; } }
        public override ClrAppDomain SystemDomain { get { return _appDomains.Value.System; } }
        public override ClrAppDomain SharedDomain { get { return _appDomains.Value.Shared; } }
        public bool IsSingleDomain { get { return _appDomains.Value.Domains.Count == 1; } }
        ...
        public ClrModule Mscorlib { get { return _mscorlib.Value; } }
    ...
    internal struct MethodTableTokenPair
    {
        ...
        public MethodTableTokenPair(ulong methodTable, uint token): this()
        {
