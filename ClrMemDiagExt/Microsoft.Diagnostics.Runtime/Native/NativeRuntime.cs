                    ...
                    if (nativeModule != null)
                    {
                        if (nativeModule.Pdb != null)
                        {
                            try
                            {
                                ...
                                {
                                    Trace.WriteLine("Unable to find symbol resolver for PDB [Filename: "+nativeModule.Pdb.FileName+", GUID: "+nativeModule.Pdb.Guid.ToString()+", Revision: "+nativeModule.Pdb.Revision+"]");
                                }
                            }
                            catch (Exception e)
                            {
                                Trace.WriteLine("Error in finding the symbol resolver for PDB [Filename: "+nativeModule.Pdb.FileName+", GUID: "+nativeModule.Pdb.Guid.ToString()+", Revision: "+nativeModule.Pdb.Revision+"]: "+e.Message);
