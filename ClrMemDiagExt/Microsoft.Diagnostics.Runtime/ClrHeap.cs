...
namespace Microsoft.Diagnostics.Runtime
{
    ...
    public abstract class ClrHeap
    {
        ...
        /// </summary>
        virtual public bool IsHeapCached { get { return false; } }
        ...
        /// </summary>
        internal virtual long TotalObjects { get { return -1; } }
    }
    ...
    internal abstract class HeapBase : ClrHeap
    {
        ...
        public override IEnumerable<ClrObject> EnumerateObjects()
        {
            ...
            for (int i = 0; i < _segments.Length; ++i)
            {
                ...
                ClrType type;
                for (ulong obj = seg.GetFirstObject(out type); obj != 0; obj = seg.NextObject(obj, out type))
                {
                    _lastSegmentIdx = i;
