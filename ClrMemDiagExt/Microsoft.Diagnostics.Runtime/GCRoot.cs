...
namespace Microsoft.Diagnostics.Runtime
{
    ...
    public class GCRoot
    {
        ...
        private bool _allowParallel = true;
        /// <summary>
        ...
        /// </summary>
        public bool AllowParallelSearch { get { return _allowParallel; } set { _allowParallel = value; } }
        ...
        public int MaximumTasksAllowed
        {
            ...
            {
                if (_maxTasks < 0)
                    throw new InvalidOperationException(String.Format("{0} cannot be less than 0!", "MaximumTasksAllowed"));
        ...
        private void ReportObjectCount(long curr, ref long lastObjectReported, long totalObjects)
        {
            if (curr != lastObjectReported)
            {
                ...
                if(ProgressUpdate != null) ProgressUpdate.Invoke(this, lastObjectReported, totalObjects);
            }
        }
        ...
        {
            Debug.WriteLine("Considering: "+(new ClrObject(next, _heap.GetObjectType(next))).ToString()+" Refs: "+string.Join(" ", refs));
        }
